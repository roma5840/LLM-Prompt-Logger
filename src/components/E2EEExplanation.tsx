  ...
  return (
    <div className="space-y-6 text-sm">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Before your conversation titles, turn summaries, and token counts are saved, they are scrambled into unreadable ciphertext using your encryption key.</p>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="rounded-lg border p-4 bg-green-500/5 border-green-500/20">
          ...
          <ul className="list-disc list-inside mt-2 text-muted-foreground space-y-1">
            <li>Your conversation titles</li>
            <li>The content of your turn summaries</li>
      ...
      <p className="text-xs text-center text-muted-foreground pt-2">
        This minimal metadata is necessary for the app to function (e.g., sorting conversations and calculating costs) but does not expose your private content.
      </p>
    </div>
  )
}